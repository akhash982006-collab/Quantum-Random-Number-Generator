...
PAGES=['COMMAND CENTER','DATA INGESTION','ENTROPY ANALYSIS','NIST VALIDATION','DEGRADATION MONITOR','ENTROPY FORENSICS','FAILURE LAB','WHAT-IF ANALYSIS','QRNG HEALTH PASSPORT','REPORTS','METHODOLOGY']
